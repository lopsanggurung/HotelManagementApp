...
@Injectable()
export class PendingLaundryReceiveListResolver implements Resolve<LaundryService[]> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<LaundryService[]> {
        return this.laundryServiceService.getPendingLaundryToReceiveFromLaundry().pipe(
            catchError(error => {
