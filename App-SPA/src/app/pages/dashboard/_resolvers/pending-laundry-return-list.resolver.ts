...
@Injectable()
export class PendingLaundryReturnListResolver implements Resolve<LaundryService[]> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<LaundryService[]> {
        return this.laundryServiceService.getPendingLaundryToReturnToGuest().pipe(
            catchError(error => {
